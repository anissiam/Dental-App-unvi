...
public class MonthActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(MonthActivity.this);
        /*mLayoutManager.setReverseLayout(true);
        mLayoutManager.setStackFromEnd(true);*/
        rv_paetint.setLayoutManager(mLayoutManager);

        Adapter = new MonthAdapter (_cxt, List_vist);
